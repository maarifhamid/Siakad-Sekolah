            ...
            <div class="col-xs-12">
              <div class="box">
				...
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Add</button></a>
                  <br></br>
				  <table id="" class="table table-bordered table-striped table-scalable table-hover">
						<?php
							...
							<div class="form-group">
								<label>Kurikulum</label>
									<div class="input-group">
										...
										<select name="Kode_Kurikulum" class="form-control">
											<?php
												...
												while($kurikulum = mysqli_fetch_array($querykurikulum)){
													echo "
														<option value='$kurikulum[Kode_Kurikulum]'>$kurikulum[Kurikulum]</option>";
												}
											?>
										</select>
									</div>
