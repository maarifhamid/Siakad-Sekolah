    ...
    <div class="wrapper">
			  ...
			  <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>   
			        <li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="jenjang.php"><i class="fa fa-graduation-cap"></i><span>Kurikulum</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-graduation-cap"></i> Kurikulum</li>
          </ol>
        </section>
							...
							<div class="form-group">
								<label>Kode Kurikulum</label>
									<div class="input-group">
										...
										<input name="Kode_Kurikulum" type="text" class="form-control" placeholder="Kode Kurikulum"/>
									</div>
							</div>
							<div class="form-group">
								<label>Kurikulum</label>
									<div class="input-group">
										...
										<input name="Kurikulum" type="text" class="form-control" placeholder="Kurikulum"/>
									</div>
							</div>
		...
		<!-- Modal Popup Kurikulum Edit -->
		<div id="ModalEditKurikulum" class="modal fade" tabindex="-1" role="dialog"></div>
