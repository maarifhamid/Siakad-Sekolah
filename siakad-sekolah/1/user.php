											...
											<?php
												...
												while($dosen = mysqli_fetch_array($querydosen)){
													if($dosen["NIP"] != $_SESSION["Username"]){
														echo "<option value='$dosen[NIP]'>$dosen[Nama_Dosen], Tambah Guru untuk User dengan NIP = $dosen[NIP]</option>";
													}
												}
											?>
										</select>
											...
											<?php
												...
												while($mhs = mysqli_fetch_array($querymahasiswa)){
													if($mhs["NIM"] != $_SESSION["Username"]){
														echo "<option value='$mhs[NIM]'>$mhs[Nama_Mahasiswa], Tambah Siswa untuk User dengan NIS = $mhs[NIM]</option>";
													}
												}
											?>
										</select>
