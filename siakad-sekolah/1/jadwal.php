							...
							<div class="form-group">
								<label>Mata Pelajaran</label>
									<div class="input-group">
										...
										<select name="Kode_Mapel_Jadwal" class="form-control">
											<?php
												
												$querymtk = mysqli_query ($konek, "SELECT * FROM mapel");
												if ($querymtp == false){
													die ("Terdapat Kesalahan : ". mysqli_error($konek));
												}
												while ($mtp = mysqli_fetch_array($querymtp)){
													echo "<option value='$mtp[Kode_Mapel]'>$mtp[Mata_Pelajaran]</option>";
												}
											?>
										</select>
									</div>
										...
										<select name="Kode_Kelas_Jadwal" class="form-control">
											<?php
												...
												while ($kelas = mysqli_fetch_array($querykelas)){
													echo "<option value='$ruang[Kode_Kelas]'>$ruang[Nama_Kelas]</option>";
												}
											?>
										</select>
									</div>
